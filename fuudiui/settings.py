"""
Django settings for fuudiui project.
...
SECRET_KEY = 'django-insecure-(v3fwz@b+pc(h(v45kwnh3wac*40as#tgj&$7c8-2i!is!nvw7'
...
WSGI_APPLICATION = 'fuudiui.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ["http://localhost","http://127.0.0.1","http://patricia-gloria-fuudiui.pbp.cs.ui.ac.id", "http://patricia-gloria-fuudiui.pbp.cs.ui.ac.id"]
